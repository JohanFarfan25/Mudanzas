 ...
 */
package com.confimudanzas.utilidades;
...
public class Email {
    public static void sendModificacion(String para, String Nombres, String nombUsu, String clave) {
        final String user = "infoconfimudanzas@gmail.com";//cambiará en consecuencia al servidor utilizado
        final String pass = "Infomudanzas2021";
...
//2nd paso)compose message
        try {
            ...
            message.setFrom(new InternetAddress(user));
            message.addRecipient(Message.RecipientType.TO, new InternetAddress(para));
            message.setSubject("Recordatorio Claves confi - Mudanzas");
